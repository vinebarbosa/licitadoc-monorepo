# web-route-fallback-pages Specification

## Purpose
Defines the dedicated unauthorized and not-found route experiences and their integration into the centralized web router.
