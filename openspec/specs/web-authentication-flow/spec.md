...
## Purpose
Defines the modular web authentication routes, auth-contract integration, request-access flow, and session-aware route protection expectations for the frontend app.
