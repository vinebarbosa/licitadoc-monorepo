...
{{dfd.context_and_need}}

## 3. OBJETO DA CONTRATAÇÃO

{{dfd.contracting_object}}

## 4. JUSTIFICATIVA E RELEVÂNCIA DA CONTRATAÇÃO

{{dfd.justification_and_relevance}}

## 5. REQUISITOS ESSENCIAIS PARA A CONTRATAÇÃO

- {{dfd.essential_requirement_1}}
- {{dfd.essential_requirement_2}}
- {{dfd.essential_requirement_3}}
