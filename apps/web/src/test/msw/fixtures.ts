  ...
  items: [
    {
      ...
      slug: "prefeitura-de-sao-benedito-do-rio-preto",
      officialName: "Município de São Benedito do Rio Preto",
      cnpj: "08.319.747/0001-90",
      city: "São Benedito do Rio Preto",
      state: "MA",
      address: "Rua Senador Vitorino Freire, 120, Centro",
      zipCode: "65715-000",
      phone: "(99) 3471-1200",
      institutionalEmail: "contato@saobeneditoriopreto.ma.gov.br",
      website: "www.saobeneditoriopreto.ma.gov.br",
      logoUrl: null,
      crestUrl: null,
      letterhead: null,
      letterheadTemplateUrl: null,
      authorityName: "João Carlos Pereira Sousa",
      authorityRole: "Prefeito Municipal",
      isActive: true,
  ...
  items: [
    {
      ...
      slug: "secretaria-administracao",
      organizationId: "organization-1",
      budgetUnitCode: "02.001",
      responsibleName: "Marcos Aurélio Ribeiro",
      responsibleRole: "Secretário Municipal de Administração",
      createdAt: "2026-04-01T00:00:00.000Z",
      updatedAt: "2026-04-01T00:00:00.000Z",
    },
    {
      ...
      slug: "secretaria-financas",
      organizationId: "organization-1",
      budgetUnitCode: "02.002",
      responsibleName: "Antônio Bezerra Cardoso",
      responsibleRole: "Secretário Municipal de Finanças",
    ...
    },
    {
      ...
      organizationId: "organization-1",
      budgetUnitCode: "02.003",
      responsibleName: "Rodrigo Santos Teixeira",
      responsibleRole: "Secretário Municipal de Obras",
...
export const invitesListResponse = {
  items: [
    {
      id: "invite-1",
      email: "luciana.porto@saobeneditoriopreto.ma.gov.br",
      role: "member",
      organizationId: "organization-1",
    ...
    {
      id: "invite-2",
      email: "heloise.santos@saobeneditoriopreto.ma.gov.br",
      role: "member",
      organizationId: "organization-1",
      invitedByUserId: "user-1",
      provisionedUserId: null,
...
export const usersListResponse = {
  items: [
    {
      id: "user-1",
      name: "Fernanda Alves Costa",
      email: "fernanda.alves@saobeneditoriopreto.ma.gov.br",
      emailVerified: true,
      image: null,
    ...
    {
      id: "user-2",
      name: "Marcos Aurélio Ribeiro",
      email: "marcos.ribeiro@saobeneditoriopreto.ma.gov.br",
      emailVerified: true,
      image: null,
      role: "member",
      organizationId: "organization-1",
    ...
    },
    {
      ...
      email: "patricia.mendes@saobeneditoriopreto.ma.gov.br",
      emailVerified: true,
      image: null,
      role: "member",
      organizationId: "organization-1",
    ...
    {
      id: "user-4",
      name: "Rodrigo Santos Teixeira",
      email: "rodrigo.santos@saobeneditoriopreto.ma.gov.br",
      emailVerified: true,
      image: null,
      role: "member",
      organizationId: "organization-1",
    ...
    {
      id: "user-5",
      name: "Antônio Bezerra Cardoso",
      email: "antonio.bezerra@saobeneditoriopreto.ma.gov.br",
      emailVerified: true,
      image: null,
      role: "member",
      organizationId: "organization-1",
