...
const steps: Array<{ id: ProcessStep; label: string; description: string }> = [
  ...
  { id: "vinculos", label: "Vínculos", description: "Organização e unidades" },
...
export function ProcessCreateDemoPage() {
  ...
  const [values, setValues] = useState<FormValues>({
    ...
    items: [
      ...
      },
      {
        ...
        description: "Kit completo para estação de trabalho com periféricos",
        quantity: "25",
        unit: "KIT",
        unitValue: "1200.00",
        totalValue: "30000.00",
  ...
  function validateStep(): boolean {
    ...
    if (currentStep === "vinculos") {
      if (!values.organizationId) newErrors.organizationId = "Selecione a organização";
            ...
            {currentStep === "vinculos" && (
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Selecione a organização e as unidades orçamentárias vinculadas ao processo.
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="space-y-2">
