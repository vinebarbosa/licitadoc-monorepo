          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div className="space-y-8">
              ...
              <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-xl">
                Gere documentos oficiais exigidos pela Nova Lei de Licitações de forma inteligente:
                DFD, ETP, Termo de Referência e Minuta de Contrato.
              </p>
        ...
        <div className="container mx-auto max-w-7xl px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-lg text-muted-foreground">
              Ferramentas desenvolvidas especificamente para atender às exigências da Nova Lei de
            ...
            {[
              {
                ...
                description:
                  "Gere DFDs completos com justificativa, alinhamento estratégico e requisitantes identificados.",
              },
              {
                icon: FileCheck,
                title: "Estudo Técnico Preliminar",
                description:
                  "ETPs detalhados com análise de soluções, riscos identificados e viabilidade técnica.",
              },
              {
                icon: Scale,
                title: "Termo de Referência",
                description:
                  "TRs estruturados com especificações técnicas, critérios de julgamento e obrigações contratuais.",
              },
              {
                icon: Shield,
                title: "Conformidade Garantida",
                description:
                  "Todos os documentos seguem rigorosamente os requisitos da Lei 14.133/2021.",
              },
              {
                icon: Clock,
                title: "Agilidade no Processo",
                description:
                  "Reduza drasticamente o tempo de elaboração dos documentos preparatórios.",
              },
              {
                icon: Users,
                title: "Colaboração em Equipe",
                description:
                  "Múltiplos usuários podem trabalhar no mesmo processo simultaneamente.",
              },
            ].map((feature) => (
              <Card
                key={feature.title}
            ...
            {[
              {
                ...
                description:
                  "Insira as informações básicas da contratação: objeto, modalidade e área requisitante.",
              },
              {
                step: "02",
                title: "Preencha os dados",
                description:
                  "Complete os campos específicos de cada documento com auxílio de sugestões inteligentes.",
              },
              {
                step: "03",
                title: "Gere e exporte",
                description:
                  "Obtenha documentos formatados prontos para assinatura e anexação ao processo.",
              },
            ].map((item, index) => (
          ...
          <div className="relative overflow-hidden rounded-3xl bg-sidebar p-8 md:p-16">
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <p className="text-lg text-sidebar-foreground/70 mb-8">
                Solicite acesso à plataforma e comece a gerar documentos em conformidade com a Nova
                Lei de Licitações ainda hoje.
              </p>
              <div className="flex flex-col sm:flex-row gap-4">
                ...
                <Button
                  size="lg"
                  variant="outline"
                  className="h-12 px-8 border-sidebar-border text-sidebar-foreground hover:bg-sidebar-accent"
                  asChild
                >
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-sm text-muted-foreground max-w-sm leading-relaxed">
                Plataforma de geração de documentos para contratações públicas, em conformidade com
                a Lei 14.133/2021.
              </p>
            </div>
